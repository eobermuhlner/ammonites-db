...
VALUES
('Perisphinctaceae', 'Perisphinctidae', 'Perisphinctinae', 'Perisphinctes', 'Larcheria', 'Larcheria gredingensis', '', 'Schlegelmilch, Malm, Image: 21.5', 'ox 1 f'),
('Perisphinctaceae', 'Perisphinctidae', 'Perisphinctinae', 'Perisphinctes', 'Larcheria', 'Larcheria dorni', '', 'Schlegelmilch, Malm, Image: 21.6', 'ox 1 c');
