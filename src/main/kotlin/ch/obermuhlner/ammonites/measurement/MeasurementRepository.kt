    ...
    fun save(measurement: Measurement): Measurement {
        if (measurement.id == null) {
            ...
            dsl.update(MEASUREMENT)
                ...
                .set(MEASUREMENT.COUNT_PRIMARY_RIBS, measurement.countPrimaryRibs)
                .set(MEASUREMENT.COUNT_SECONDARY_RIBS, measurement.countSecondaryRibs)
                .set(MEASUREMENT.RIB_DIVISION_RATIO, measurement.ribDivisionRatio)
