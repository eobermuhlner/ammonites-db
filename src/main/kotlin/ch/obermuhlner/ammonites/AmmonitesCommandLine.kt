...
fun main(args: Array<String>) {
    ...
    val sortedMatches = ammoniteService.findMatchingAmmonitesWithMeasurements(diameterSide = 2.7, diameterCross = 0.1 , proportion_n = 39.0, proportion_h = 36.0, proportion_q = 1.0, count_z = 38.0)
